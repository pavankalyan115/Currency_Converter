...
public class Currency {
	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("Rup", 70.00);
			...
			case "Euro":
				...
				this.exchangeValues.put("Rup", 80.00);
			...
			case "British Pound":
				...
				this.exchangeValues.put("Rup", 1.50);
			...
			case "Swiss Franc":
				...
				this.exchangeValues.put("Rup", 0.50);
			...
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("Rup", 0.10);
			...
			case "Japanese Yen":
				...
				this.exchangeValues.put("Rup", 0.001);
				this.exchangeValues.put("CNY", 0.051);
				this.exchangeValues.put("JPY", 1.000);
				break;
			case "Indian Rupee":
			    this.exchangeValues.put("Rup", 1.000);
				this.exchangeValues.put("USD", 0.008);
				this.exchangeValues.put("EUR", 0.007);
				this.exchangeValues.put("GBP", 0.005);
				this.exchangeValues.put("CHF", 0.008);
				this.exchangeValues.put("CNY", 0.051);
				this.exchangeValues.put("JPY", 500.000);
	...
	public static ArrayList<Currency> init() {
	    ...
	    currencies.add( new Currency("Indian Rupee", "Rup") );		
